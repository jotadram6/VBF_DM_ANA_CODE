...
private:
  ...
  bool passRecoLeptonMetTopologyCuts(int); 
  std::pair<bool, TLorentzVector> matchLeptonToGen(TLorentzVector);
  ...
  int ExtractNumberOfGoodGen(int,int);
  ...
  TLorentzVector SmearLepton(TLorentzVector,string);
  std::map<string,vector<double> > smearDictionary;
